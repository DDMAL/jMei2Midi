...
/**
 * A factory design pattern to build the appropriate LayerChild object
 * given the specified MeiElement child object.
 * 
 * <p>Currently this is used in the MeiSequence class' processElement() function.
 * Before building a LayerChild, the LayerChildEnum class should validate
 * the appropriate MeiElement object. If not validated and the MeiElement
 * is invalid, this class will return null.</p>
...
public final class LayerChildFactory {
	 ...
	 * as this class should only be called statically.
	 */
     ...
     * @param child the MeiElement whose name will produce the appropriate LayerChild object
     * @return the appropriate LayerChild object based on child name
     * 		   and if the name is not a valid LayerChild sub class, return null
     */
